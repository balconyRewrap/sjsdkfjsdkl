...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-dir", type=Path, default=Path("models/scratch-transformer-safety"))
...
def main() -> None:
    ...
    if not config_path.exists() or not vocab_path.exists() or not weights_path.exists():
        raise SystemExit(f"Missing safety model artifacts in {args.model_dir}")
